...
test('Default value, factor:2, overlap:false', () => {
  const result = broadenPeaks([
    {
      x: -0.5,
      y: 1,
...
test('no change, factor:1, overlap:false', () => {
  const result = broadenPeaks(
    [
      {
        x: -0.5,
